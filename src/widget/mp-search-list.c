...
static void _mp_search_list_set_itc(void *thiz)
{
	...
	if (!list->itc_track) {
		...
		list->itc_track->item_style =  "type1";//"music/2text.1icon.tb";
	...
	if (!list->itc_album) {
		...
		list->itc_album->item_style =  "type1";//"music/2text.1icon.tb";
	...
	if (!list->itc_artist) {
		...
		list->itc_artist->item_style = "type1";//"music/1text.1icon.2.tb";
